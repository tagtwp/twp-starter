...
`git clone https://github.com/tagtwp/twp-starter.git`
...
Run this command after `npm install` if you need to copy minified (dist) files of modules listed in package.json "dependencies" to `src/assets/libs` directory using in project.
...
│   ├──📁 templates/                            # folder for storing html partials of the page
│   │   └──📃templates-name.html                # particle html component
...
│   │   └──📁 libs/                             # Copy minified (dist) files of modules listed in package.json "dependencies".
